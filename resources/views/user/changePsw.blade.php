...
<div class="limiter" id="login">
    <div class="container-login100" style="background-image:url(https://www.moroccoworldnews.com/wp-content/uploads/2014/04/Al-Akhawayn-University1.jpg)">
        <div class="container">
            <div class="row">
                <div class="col-md-6"></div>
                <div class="col-md-5 col-md-offset-1">
                <div class="login_topimg"> 
                            <img src="../../../../../../dist/img/logo2.png" class="APPlOGO" >
                        </div>
                        
                    <div class="wrap-login100">
                        
                          <form action="{{route('changepassword')}}" method="post" class="login100-form validate-form">
                              <input type="hidden" name="_token" value="{{ csrf_token() }}">
                           
                                 <span class="login100-form-subtitle m-b-16">
                                    <span style="color: #001a00; font-size: 45px; font-family:Algerian">AUI</span><span style="color:relativerelativerelative; font-family: Amasis MT Pro Blackfont-size;font-size:37px;">Pockets</span>
                                </span>
                            ...
                            <div class="container-login100-form-btn p-t-25"> 
                                <button type="submit" class="login100-form-btn SendNewPass"> Send New password </button>
...
.APPlOGO{
            max-height: 180px; max-width: 180px; margin-left: 135px;margin-top: 35px; border-top-left-radius: 10px;
                                border-top-right-radius: 10px;
        }
#login button {
...
@media (max-width: 768px) {
    ...
    .APPlOGO{
                ...
                max-height: 180px; max-width: 180px; margin-left: 49px;margin-top: 12px;margin-bottom: 2px; border-top-left-radius: 10px;
                                    border-top-right-radius: 10px;padding-bottom:10px;
...
@media (max-width: 600px) {
    ...
    transition: all 0.4s
            ...
            max-height: 50%; max-width: 50%; margin-left: 27%;margin-top: 10px; margin-bottom: 1px;border-top-left-radius: 10px;
                                border-top-right-radius: 10px;padding-bottom:10px;
...
if(erreur!=""){
   ...
   swal("Invalid Email!", valid, "error");
